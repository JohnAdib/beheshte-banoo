...
--
-- Host: localhost
-- Generation Time: Feb 10, 2015 at 03:41 PM
...
(1, 3, 1, 0, '2015-02-08', NULL, NULL, NULL, 'delete', '2015-02-08 14:28:10');
...
CREATE TABLE IF NOT EXISTS `userlogs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userlog_cat` varchar(50) NOT NULL,
  `userlog_name` varchar(50) NOT NULL,
  `userlog_value` varchar(200) NOT NULL,
  `userlog_extra` varchar(500) DEFAULT NULL,
...
(1, 5, 'cookie_token', '2130706433', '26f7481948276769b18f511a466a87d3', NULL, 'enable', NULL);
...
(3, 'male', 'Javad', 'Evazzadeh', '9893572697591', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 1, NULL, 'active', '0000-00-00 00:00:00', '2015-02-09 18:53:12', NULL),
(5, 'male', '', '', '989357629759', NULL, '$2y$07$x889MdhsRxGcGshcrqdEc.mcx0e1o2PeIjJPKx0VdxK4LQ1xDnZUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 4, NULL, 'active', '2015-02-09 22:44:14', '2015-02-10 11:53:07', NULL);
