...
function take_snapshot() {
  Webcam.snap( function(data_uri) {
    document.getElementById('my_camera_result').innerHTML = '<img src="'+data_uri+'"/>';

    var raw_image_data = data_uri.replace(/^data\:image\/\w+\;base64\,/, '');
    document.getElementById('webcamimage').value = raw_image_data;
 });
}
...
$(document).ready(function(){
  $('#my_camera_result').click(function(){ clearCamera(); });

  $('#submit').click(function(){
    var barcode = parseInt(document.getElementById('barcode').value);
    if(typeof barcode != 'number' || barcode.toString().length != '5')
    {
    ...
    $('#form-barcode').ajaxifyCallbacks({complete: function(data){
      if(data.status == 1){
        ...
        var myCounter = new Countdown({  
          ...
          onCounterEnd: function(){clearCamera();}
        });
        myCounter.start();
      }
      else
...
function clearCamera(){
  document.getElementById('my_camera_result').innerHTML = null;
  document.getElementById('webcamimage').value = null;
